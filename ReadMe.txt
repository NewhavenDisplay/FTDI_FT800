...
-------------------------
Version 1.5.1 (NHD) - Jan/20/2022:
	- Merged example programs from FTDI_FT800 library on NHD website.
...
Supported platforms:
---------------------
 - NHD-4.3RTP-SHIELD - Newhaven Display 4.3" TFT Shield for Arduino w/ Resistive Touch (FT800)
