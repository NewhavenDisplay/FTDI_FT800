...
/**
* @file                           FT_VM800P35.h
* @brief                          Contains arduino specific macros for VM800P35 platform.
...
/* This platform contains FT800 hardware, resistive touch, QVGA display panel, atmega328p au mcu, rtc, sdcard via spi, uart connection from pc */
