...
* @brief                          This sketch demonstrates the usage of the FT800 audio engine and how the standard Arduino SD library can be used instead of the FTDI's custom SD library.
...
/* API to demonstrate audio playback on FT800. Application uses 100KBytes of buffer in gram to playback one shot, downloads the audio data into gram continuously */
void AudioPlayback()
{
	uint8_t Percent = 0;
