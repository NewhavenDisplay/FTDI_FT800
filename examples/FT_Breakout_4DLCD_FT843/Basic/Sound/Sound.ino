...
/**
* @file                           Sound.ino
* @brief                          This file demonstrates the usage of audio engine of FT800.
...
/* API to demonstrate the usage of sound api of FT800. Play a synthesized sound with respective frequency and volume */
...
void setup()
{
  	...
  	else
	{
		...
		Sound(1,0);//api to demonstrate the usage of sound engine on FT800 - default values for the first time
	}	
}
