...
void Sketch()
{
	...
	FTImpl.Cmd_Sketch( BorderSz,BorderSz,(FT_DISPLAYWIDTH - 2*BorderSz),(FT_DISPLAYHEIGHT - 2*BorderSz),0,FT_L1);//sketch in L1 format
	/* Display the sketch */
	FTImpl.DLStart(); //start the display list. Note DLStart and DLEnd are helper apis, Cmd_DLStart() and Display() can also be utilized.
	...
	FTImpl.Cmd_Memzero(FT_RAM_G,MemZeroSz);
	FTImpl.Cmd_Sketch( BorderSz,BorderSz,(FT_DISPLAYWIDTH - 2*BorderSz),(FT_DISPLAYHEIGHT - 2*BorderSz),0,FT_L8);//sketch in L8 format
	/* Display the sketch */
	FTImpl.DLStart(); //start the display list. Note DLStart and DLEnd are helper apis, Cmd_DLStart() and Display() can also be utilized.
