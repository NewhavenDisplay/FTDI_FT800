...
/**
* @file                           Spinner.ino
* @brief                          Sketch to display Spinner functionality on FT800.
...
void Spinner(int16_t style, int16_t scale)
{
	...
	FTImpl.Finish();//render the commands to ft800
}
...
{
	//error handling
	if(1 == ginit)//operate the spinner only if ft800 is initialized
	{	
