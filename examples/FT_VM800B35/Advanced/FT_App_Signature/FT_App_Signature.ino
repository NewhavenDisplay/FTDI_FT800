...
char *info[] = {  "FT800 Signature Application",
...
{	
  ...
  FTImpl.ColorRGB(255, 255, 255); //set color of bitmap to white
  ...
  FTImpl.BitmapSize(FT_NEAREST, FT_REPEAT, FT_REPEAT, 512, 512); //set bitmap size
...
// Intialize the bitmap properties and sketch properties  
  ...
  FTImpl.Cmd_Sketch(x,y,w,h,10*1024L,FT_L8);	  
