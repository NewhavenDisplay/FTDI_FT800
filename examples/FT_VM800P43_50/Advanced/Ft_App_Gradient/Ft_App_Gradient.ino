...
*****************************************************************************/
/**
* @file                           FT_App_Gradient.ino
* @brief                          This file demonstrates the usage of interactive Gradient function.
...
void Gradient()
{
  ...
  FTImpl.BitmapSource(4096L);	//set bitmap source
  FTImpl.BitmapLayout(FT_L8,1,FT_DISPLAYHEIGHT);	//set bitmap layout
  FTImpl.BitmapSize(FT_NEAREST, FT_REPEAT, FT_BORDER, FT_DISPLAYWIDTH, FT_DISPLAYHEIGHT); //set bitmap size
